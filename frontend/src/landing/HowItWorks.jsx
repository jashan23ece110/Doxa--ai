        ...
        {STEPS.map((s, idx) => {
          ...
          return (
            <motion.div
              ...
              className="relative p-6 rounded-2xl bg-white border border-neutral-200/80 flex flex-col gap-4 shadow-md shadow-neutral-100/50 hover:border-violet-500/20 transition-all duration-300 hover:-translate-y-1"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono font-bold text-violet-600">STEP {s.step}</span>
                <div className="p-2.5 rounded-xl bg-violet-50 text-violet-600 border border-violet-100">
                  <Icon className="w-5 h-5" />
                </div>
              </div>
              <h3 className="text-lg font-bold text-neutral-900 font-orbitron" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                {s.title}
              </h3>
